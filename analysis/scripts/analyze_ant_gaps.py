...
This script parses the exp_debug0.log files to extract and analyze
...
def parse_ant_distance_stats(log_file):
    ...
    Args:
        log_file: Path to the exp_debug0.log file
...
def main():
    ...
    # Define experiments to analyze - edit paths as needed
    experiments = [
        {
            "name": "exp_cifar100_10-10_antB1_nceA1_antM0.1_antLocal_v2",
            "log_file": "../../logs/exp_cifar100_10-10_antB1_nceA1_antM0.1_antLocal_v2/exp_debug0.log",
...
def create_comparative_plot(all_epoch_stats):
    ...
    plt.tight_layout()
    output_file = "../results/experiments_comparison/ant_gap_analysis_comparative.png"
    plt.savefig(output_file, dpi=150, bbox_inches="tight")
