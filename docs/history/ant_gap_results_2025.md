# Registro histórico: `docs/analysis/ANALISE_BASELINE_VS_ANT_GAP.md`

Comparação histórica ANT+Gap e correção do cálculo do gap do baseline. Igualdade aproximada do gap médio não prova redundância geral da ANT. A confiança “95%+” da nota paralela não tinha procedimento documentado e não é adotada aqui.
