# Registro histórico: `docs/ant_investigation_results.md`

Resultados de maio de 2026, seis execuções, seed 1995. Preservam a escolha de formulação. As conclusões de generalização e de ausência de impacto de correções não são universais nem foram revalidadas nesta revisão. Flags históricas dependem da versão do código.
