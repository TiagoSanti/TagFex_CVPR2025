# Registro histórico: `docs/ant_loss_flattening_investigation_plan.md`

Plano anterior à investigação de maio de 2026. Diagnósticos e etapas iniciais já foram implementados; o próximo passo descrito não é uma fila atual. A exigência de gradiente nos embeddings não proíbe o detach deliberado apenas da referência.
