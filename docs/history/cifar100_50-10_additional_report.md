# Registro histórico: `analysis/results/cifar100_50-10_comparison/cifar100_50-10_global_vs_local_report.md`

Registro complementar, não confirmado como o mesmo conjunto de runs da outra tabela 50-10. A descrição “50 initial classes + 10 incremental tasks” é incorreta para CIFAR-100 50-10. A hipótese de métodos InfoNCE local/global distintos foi superada; valores não foram recalculados.
