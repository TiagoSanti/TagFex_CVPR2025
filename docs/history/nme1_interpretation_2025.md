# Interpretação histórica das curvas NME

Narrativa original de novembro de 2025, preservada para rastreio. Comandos,
roteiro e conclusões não são orientação atual. O resumo numérico distingue
runs com 7, 8 e 10 tarefas; diferenças de última acurácia entre horizontes
não são ganhos comparáveis. Queda T1→Tfinal não é forgetting por bloco.
