# Registro histórico: `docs/RESULTS_AND_METRICS.md`

Ranking e recomendações históricos de dezembro de 2025. “InfoNCE Local” não é método distinto; os ganhos aqui não demonstram efeito dessa normalização. As generalizações de melhor configuração não valem para as campanhas atuais.
