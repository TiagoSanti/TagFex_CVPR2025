#!/usr/bin/env bash
# Seeds 1996/1997, Wolverine GPU 1 shard.
...
QUEUE="$SCRIPT_DIR/experiments/ant_central_extra_seeds/queues/queue_ant_central_extra_seeds_wolverine_gpu1.txt" \
LOCKFILE="$TAGFEX_LOCK_DIR/tagfex_ant_central_extra_seeds_wolverine_gpu1.lock" \
ORCH_LOG="$CAMPAIGN_ROOT/orchestrator/ant_central_extra_seeds_wolverine_gpu1.log" \
CONSOLE_DIR="$CAMPAIGN_ROOT/orchestrator/gpu1_console" \
GPUS=1 \
