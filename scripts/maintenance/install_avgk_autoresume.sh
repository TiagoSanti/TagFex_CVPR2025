...
REPO_ROOT="$TAGFEX_ROOT"
RUN_SCRIPT="$REPO_ROOT/scripts/execution/run_avgk_queue.sh"
...
echo "Duplicate launches are suppressed by flock ($REPO_ROOT/scripts/execution/run_avgk_queue.sh)."
echo ""
